...
-- More Bindings!
hl.bind("SUPER + V", hl.dsp.exec_cmd("cursor-clip"))
...
hl.workspace_rule({ workspace = "3" ,monitor="DP-5", default=true, persistent=true, default_name="main"})

hl.workspace_rule({ workspace = "4" ,monitor="DP-6", default=true, persistent=true})
